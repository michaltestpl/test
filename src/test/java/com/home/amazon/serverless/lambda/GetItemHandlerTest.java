...
public class GetItemHandlerTest {
    ...
    public void shouldReturnItemIfExists() {
        ...
        queryParameters.put(Book.PARTITION_KEY, TEST_PARTITION_KEY_VALUE);
        Book testBook = new Book();
        testBook.setIsbn(TEST_PARTITION_KEY_VALUE);
        when(table.getItem(any(Key.class))).thenReturn(testBook);
        when(request.getQueryStringParameters()).thenReturn(queryParameters);
    ...
    public void shouldReturnEmptyResponseIfItemNotExists() {
        ...
        when(request.getQueryStringParameters()).thenReturn(new HashMap<>());
    ...
    @Test
    public void shouldReturnEmptyResponseIfQueryParameterMissed() {
        when(request.getQueryStringParameters()).thenReturn(null);
